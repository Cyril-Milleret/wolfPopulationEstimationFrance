...
# Real coordinates of the collected indices are not provided. instead, we used the coordinates of the center of a subdector random chosen within main detector grid.
# For more information regarding this, please contact the DGPT service of the OFB <'JEAN Nicolas' <Nicolas.Jean@ofb.gouv.fr>>
...
#save(habitatExtent,areaSearched,file=file.path(WD,"2025/Data/Habitat.RData"))

load(file.path(WD,"2025/Data/Habitat.RData"))
